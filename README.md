...
[![Version](https://img.shields.io/badge/version-1.6.66-00C4CC.svg)](CHANGELOG.md)
...
- 回転 (`,`/`.` で 15° 単位 CCW/CW、矩形・楕円・付箋・テキスト・画像・フレーム、複数選択は群中心で公転、SVG/ミニマップ/コネクタ追従も対応、undo/redo 可逆)
