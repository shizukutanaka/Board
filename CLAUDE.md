...
│   ├── ADR-0375-text-editor-tab-chain.md   # テキストエディタ Tab 連鎖 (実装済)、ADR-0376(コネクタbboxがオフボックス経路点を包含 — curve/elbow 経路の damage/culling 修正)、ADR-0377(del connClears を8propホワイトリスト化)
