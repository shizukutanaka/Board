...
const checks = [
  ...
  ['excalidraw export emits fstyle/arrowheads/image-flip (ADR-0231)', html.includes("'cross'?'cross-hatch':'solid'")&&html.includes("startArrowhead:s.start?'arrow':null")&&html.includes("scale:[s.flip&1?-1:1")&&html.includes("d.files[e.fileId]")],
