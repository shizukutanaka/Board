...
const checks = [
  ...
  ['drawio edge opacity export (ADR-0262)', (html.match(/Math.round\(s.opacity\*100\)/g)||[]).length>=2],
  ...
  ['drawio flipH/flipV ↔ s.flip bitmask (ADR-0260)', (html.match(/flipH=1/g)||[]).length>=2&&html.includes("sty.flipH==='1'")],
