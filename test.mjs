...
const checks = [
  ...
  ['labels honor bold/italic/under/strike (ADR-0170)', html.includes('c.font=_fontStr(s,fs);c.textAlign='center';c.textBaseline='middle';   // ADR-0170')&&html.includes("s.type!=='sticky'&&!s.label)||s.locked)continue;   // ADR-0170")],
